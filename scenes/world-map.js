    ...
    render() {
      return `
        ...
        <div class="world-map-wrap">
          ...
          >
          <button class="world-map-button world-map-ice" onclick="Game.handle('go_ice')">Ice Kingdom</button>
          <button class="world-map-button world-map-sky" onclick="Game.handle('go_sky')">Sky Kingdom</button>
          <button class="world-map-button world-map-sand" onclick="Game.handle('go_sand')">Sand Kingdom</button>
        </div>
      `;
    },
